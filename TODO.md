...
This is a journal and the list of the work progress. Mainly for taking notes to be able quickly recall the current state of development.
...
### :TODO: Implement Gatling stress test
